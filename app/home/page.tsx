        ...
        <>
            ...
            <div className="screen">
                ...
                <div className="stack" style={{paddingBottom: 32}}>
                    {visible.map((donation) => <DonationCard key={donation.id} d={donation} />)}
            ...
            {isFilterOpen && (
                <div className="filter-backdrop" role="presentation" onClick={closeFilter}>
                    <div
                    ...
                    >
                        <div className="row" style={{justifyContent:"space-between", alignItems:"center"}}>
                            <div>
                                ...
                                <span style={{fontSize:12, color:"var(--muted)"}}>Selecione uma ou mais tags para refinar os resultados</span>
                            </div>
                            <button className="btn small" type="button" onClick={clearTagFilters}>
                                Limpar
                            </button>
                        </div>
                        ...
                        <button className="btn primary" type="button" onClick={closeFilter}>
                            Aplicar filtros
                        </button>
                    </div>
                </div>
